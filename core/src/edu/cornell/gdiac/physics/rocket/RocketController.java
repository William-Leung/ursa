...
public class RocketController extends WorldController implements ContactListener {
	...
	public void update(float dt) {
		...
		InputController input_controller = InputController.getInstance();
		rocket.setFX(input_controller.getHorizontal() * rocket.getThrust());
		rocket.setFY(input_controller.getVertical() * rocket.getThrust());
		rocket.applyForce();
		//#endregion
